...
TEST(ArrayTest, End) {
    s21::array<int, 5> arr = {1, 2, 3, 4, 5};
    auto it = arr.end();
    // end() не должен быть разыменован; comparing it to another iterator should work
